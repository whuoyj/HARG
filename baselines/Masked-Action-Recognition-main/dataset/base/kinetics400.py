...
from dataset.utils.random_erasing_fb import RandomErasingFB
...
class Kinetics400(BaseVideoDataset):
    ...
    def _get_dataset_list_name(self):
        ...
        name = "MOMA_{}_list.txt".format(
            split,
        )

        # name = "MOMA-LRG_{}_list.txt".format(
        #     split,
        # )
    ...
    def _get_sample_info(self, index):
        ...
        one_hot = np.zeros(num_class, dtype=int)
